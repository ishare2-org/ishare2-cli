...
```bash
curl -O /usr/sbin/ishare2 https://raw.githubusercontent.com/ishare2-org/ishare2-cli/beta/ishare2 && chmod +x /usr/sbin/ishare2 && ishare2
```
...
```bash
wget -O /usr/sbin/ishare2 https://raw.githubusercontent.com/ishare2-org/ishare2-cli/beta/ishare2
```
...
[HELP.md](https://github.com/pnetlabrepo/ishare2/blob/beta/HELP.md)

## See the latest changes on ishare2

[CHANGELOG.md](https://github.com/pnetlabrepo/ishare2/blob/beta/CHANGELOG.md)
